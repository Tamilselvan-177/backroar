...
$router->post('/admin/products/{id}/toggle-active', AdminProductController::class, 'toggleActive');
$router->post('/admin/products/{id}/toggle-featured', AdminProductController::class, 'toggleFeatured');
...
// ADMIN AJAX
$router->get('/admin/ajax/subcategories/{categoryId}', AdminProductController::class, 'ajaxSubcategories');
$router->get('/admin/ajax/models/{brandId}', AdminProductController::class, 'ajaxModels');
